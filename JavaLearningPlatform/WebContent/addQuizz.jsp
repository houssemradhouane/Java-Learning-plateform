        ...
        <div class="menu-bar">
            <div class="menu">
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                        <a href="#">
                            <span class="text nav-text">Add Courses</span>
                        </a>
                    </li>

                    <li class="nav-link">
                        <a href="#">
                            <span class="text nav-text">Add Quizzes</span>
                        </a>
                    </li>
        			 ...
        			 <div class="container">
						  <form action="Servlet" method="get">
						    ...
						    <div class="row">
						      ...
						      <div class="col-25">
						        <label for="lname">Wrong Option 1</label>
						      </div>
						      <div class="col-75">
						        <input type="text" id="woption1" name="woption1" placeholder="Wrong Option..">
						      </div>
						      <div class="col-25">
						        <label for="lname">Wrong Option 2</label>
						      </div>
						      <div class="col-75">
