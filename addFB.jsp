        			 ...
        			 <div class="container">
						  <form action="Servlet" method="get">
						    ...
						    <div class="row">
						      ...
						      <div class="col-75">
						        <textarea name="qtext" class="long field-textarea"></textarea>
						      </div>
						    </div>
						    <div class="row">
						      <div class="col-25">
						        <label for="lname">Correct Blanks</label>
						      </div>
						      <div class="col-75">
						        <input type="text" id="coption" name="option1" placeholder="Option1..">
						      </div>
						      <div class="col-75">
						        <input type="text" id="woption1" name="option2" placeholder="Option2..">
						      </div>
						      <div class="col-75">
						        <input type="text" id="woption2" name="option3" placeholder="Option3..">
						      </div>
						      <div class="col-75">
						        <input type="text" id="woption2" name="option4" placeholder="Option4..">
						      </div>
						    </div><br>
						    <div class="row">
						      <input type="submit" name="op" value="FB Done">
						    </div>
						  </form>
					</div> 
    </div>
